...
image_db_create_ripbylop_libre:
	...
	./script/addons/install_addons.sh image_creation_ripbylop_libre helpdesk_mgmt,helpdesk_mgmt_project,helpdesk_mgmt_timesheet,board,mail_activity_board,l10n_ca,project_category,project_stage_mgmt,mail_cc_show_follower,helpdesk_merge,email_cc,muk_web_theme,mail_message_reminder
...
image_db_create_ripbylop:
	...
	./script/addons/install_addons.sh image_creation_ripbylop ripbylop_configuration,helpdesk_mgmt_approbation_purchase,ripbylop_grant_fund_manage_odoo,helpdesk_mgmt_notify_customer_new_ticket,project_benefice_research,grant_fund_website_contactus,grant_fund_event_integrate
